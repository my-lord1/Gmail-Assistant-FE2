            ...
            {loading? (<div>Loading emails...</div>): (
                ...
                <div className="space-y-5 mt-6">
                        {[...thread.messages].reverse().map((msg, index) => {
                            ...
                            return (
                            <div key={msg.id} className={`border border-gray-200 rounded-xl bg-gray-50 ${isExpanded ? "p-4" : "p-2 cursor-pointer hover:bg-gray-100"}`}
                                ...
                                {isExpanded ? (
                                    <div className="prose max-w-none"
                                        dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(msg.body_html || msg.body_text.replace(/\n/g, "<br/>")),}}/>
                                    ) : (
